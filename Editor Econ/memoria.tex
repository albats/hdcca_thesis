...
% data summary table
\mctable[0.5\textwidth]{imagenes/emp_main260_summary.tex}[Baseline 260-week rolling summary for the CRSP empirical application.]{ }{tab:emp-main-summary}

% summary of Bykhovskaya-Gorin diagnostics of outliers
\mctable[0.95\textwidth]{imagenes/emp_bg_outlier_rank_summary.tex}[Rank-level summary of Bykhovskaya-Gorin diagnostics of outliers]{Importantly remember that none of the identified outliers pass the established credibility criterion (sufficient separation between signals).}{tab:emp-bg-outlier-rank-summary}
...
the established credibility criterion under these robustness checks.}{tab:emp-robustness-summary}
\FloatBarrier
...
\emptablehere[0.55\textwidth]{imagenes/emp_baseline_sample.tex}[Baseline CRSP sample design used in the empirical rolling-window application.]{ }{tab:emp-baseline-sample}
\emptablehere[0.42\textwidth]{imagenes/emp_full_spectrum_top10.tex}[Top ten squared canonical roots from the full-sample static spectrum, with the HDCCA bulk-edge classification.]{ }{tab:emp-full-spectrum}
\empfigurehere{../CRSP_Analysis/empirical_outputs_crsp/figures/figure_full_sample_static_spectrum.png}[Full-sample static canonical spectrum for the CRSP cyclical and defensive panels.]{ }{fig:emp-full-spectrum}
