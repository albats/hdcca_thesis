...
patterns of co-movement, referring to the extent to which asset returns 
...
an individual component and whether BG 
inversion formulas can be applied credibly.
...
above the bulk in all windows. This evidence indicates that the cross-panel dependence is multidimensional 
...
returns exhibit persistent cross-panel dependence.
...
cyclical and defensive stocks. However, the leading canonical 
