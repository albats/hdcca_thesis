...
Table~\ref{tab:mc-exp1-summary} and Figures~\ref{fig:mc-exp1-scree} and \ref{fig:mc-exp1-hist} 
...
Table~\ref{tab:mc-exp3-summary} and Figures~\ref{fig:mc-exp3-detection} and \ref{fig:mc-exp3-angles} 
...
Figure \ref{fig:mc-exp6-bg-correction} shows
...
Additionally, the simulations show that the Bykhovskaya-Gorin correction formulas are informative 
...
\mctable{imagenes/mc_main_results_summary.tex}[Summary of the main Monte Carlo results.]{
The table summarizes the main simulation evidence on noise inflation, threshold behavior, instability, signal concentration, and robustness.
}{tab:mc-main-results}
...
\empfigure{../CRSP_Analysis/empirical_outputs_crsp/figures/figure6_bg_outlier_diagnostics_main260.png}[Outlier BG implied population signal strength and predicted cone-angle diagnostics.]{}{fig:emp-bg-diagnostics}
\emptable{imagenes/emp_bg_outlier_rank_summary.tex}[Rank-level summary of Bykhovskaya-Gorin diagnostics of outliers]{}{tab:emp-bg-outlier-rank-summary}
...
\chapter*{Appendix}
\label{ch:Appendix1}
\section*{Appendix A: Monte Carlo Full Results}
